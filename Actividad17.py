...
etiqueta = tk.Label(ventana, text="Escriba el primer numero ",relief ="flat",font=("Arial", 10,"bold italic"),bg="#1e1e1e",fg="white")
...
etiqueta2 = tk.Label(ventana, text="Escriba el segundo numero ",relief ="flat",font=("Arial", 10,"bold italic"),bg="#1e1e1e",fg="white")
...
etiquetaP = tk.Label(ventana, text="Operaciones ",relief ="raised",font=("Arial", 10,"bold italic"),bg="#1e1e1e",fg="white")
